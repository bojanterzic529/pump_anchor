...
<p align="left">
	...
	<img src="https://img.shields.io/github/last-commit/bojanterzic529/pump_anchor?style=default&logo=git&logoColor=white&color=0080ff" alt="last-commit">
	<img src="https://img.shields.io/github/languages/top/bojanterzic529/pump_anchor?style=default&color=0080ff" alt="repo-top-language">
	<img src="https://img.shields.io/github/languages/count/bojanterzic529/pump_anchor?style=default&color=0080ff" alt="repo-language-count">
</p>
...
###  Project Index
<details open>
	<summary><b><code>PUMP_ANCHOR/</code></b></summary>
...
Before getting started with pump_anchor, ensure your runtime environment meets the following requirements:
...
Install pump_anchor using one of the following methods:

**Build from source:**

1. Clone the pump_anchor repository:
```sh
❯ git clone https://github.com/bojanterzic529/pump_anchor
```
...
###  Usage
Run pump_anchor using the following command:
**Using `cargo`** &nbsp; [<img align="center" src="https://img.shields.io/badge/Rust-000000.svg?style={badge_style}&logo=rust&logoColor=white" />](https://www.rust-lang.org/)
...
- **💬 [Join the Discussions](https://github.com/bojanterzic529/pump_anchor/discussions)**: Share your insights, provide feedback, or ask questions.
- **🐛 [Report Issues](https://github.com/bojanterzic529/pump_anchor/issues)**: Submit bugs found or log feature requests for the `pump_anchor` project.
- **💡 [Submit Pull Requests](https://github.com/bojanterzic529/pump_anchor/blob/main/CONTRIBUTING.md)**: Review open PRs, and submit your own PRs.
...
<br>
<p align="left">
   <a href="https://github.com{/bojanterzic529/pump_anchor/}graphs/contributors">
      <img src="https://contrib.rocks/image?repo=bojanterzic529/pump_anchor">
   </a>
</p>
</details>
